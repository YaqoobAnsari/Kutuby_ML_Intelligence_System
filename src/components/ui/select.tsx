...
/** Clickable trigger that opens the select dropdown. */
...
/** Scroll-up affordance shown when the list overflows upward. */
...
/** Scroll-down affordance shown when the list overflows downward. */
...
/** Floating panel containing the select items. */
